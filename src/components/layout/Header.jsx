        ...
        <button className={styles.headerBtn} onClick={() => setIsOpen(!isOpen)}>
          ...
          >
            <path
              ...
              d={
                !isOpen
                  ? "M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" // 三本線
      ...
      <nav className={`${styles.nav} ${isOpen ? styles.open : ""}`}>
        <ul className={`${styles.navList} link`}>
          <li className={styles.Welcome}>
            <Link href="/#" className={`${styles.navLink} ${styles.Welcome}`}>
          ...
          <li>
            <Link href="/mypage" className={styles.navLink}>MyPage</Link>
          </li>
          <li>
            {!isAuthenticated ? (
              <a onClick={handleLoginClick} className={`${styles.navLink} btnLg ${styles.login}`}>
                Login
              </a>
            ) : (
              <a onClick={handleLogout} className={`${styles.navLink} btnLg ${styles.login}`}>
                Logout
              </a>
            )}
          </li>
