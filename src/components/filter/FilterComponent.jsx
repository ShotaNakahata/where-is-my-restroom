...
//                   Top Rating:
//                   <input className={`${styles.checkBox}`} name='topRating' type="checkbox" checked={filters.topRating} onChange={handleChange} />
//                 </label>
...
//                 <label className={`${styles.label}`} htmlFor="topRating">
//                   Accessible:
//                   <input className={`${styles.checkBox}`} name='topRating' type="checkbox" checked={filters.accessible} onChange={handleChange} />
//                 </label>
//                 <div className={`${styles.box}`}></div>
//               </div>
